...
class HomePageNavigator extends PureComponent {
     ...
     * @param props
     * @param state
     * @returns {null|{containerWidth: null}}
     */
    static getDerivedStateFromProps(props, state) {
        if (JSON.stringify(props.tabs) !== JSON.stringify(state.tabs)
...
HomePageNavigator.propTypes = propTypes;
HomePageNavigator.defaultProps = defaultProps;
